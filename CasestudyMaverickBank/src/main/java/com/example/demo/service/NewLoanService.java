...
public class NewLoanService {
	...
	public NewLoan applyloan(NewLoan loan,double income) {
		...
		String accountNumber=loan.getAccountNumber();
	      ...
	      if(account.getStatus().equals("NotApproved")||account.getStatus().equals("closed")) {
	    	  throw new IllegalArgumentException("Your Bank Account is either not active or closed");
	      }
