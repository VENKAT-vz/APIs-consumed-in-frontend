...
public class AccountService {
    ...
    public Account addAccount(Account account, String aadhaarNumber, String panNumber,Double income) throws ClassNotFoundException, SQLException {
        ...
        Login login=lrepo.findByUsername(account.getUsername());
        
	      if(user.getStatus().equals("NotApproved")||user.getStatus().equals("closed")||login.getStatus().equals("inactive")) {
        	throw new IllegalArgumentException ("The user account is still not approved. You can't create an account.");
        }
        if (user != null) {
